...
const CHECK_PHP = ['http://localhost/Projects/MyMessenger_LOCAL/php/check.php', 'https://mymessengerbackend.000webhostapp.com/php/check.php'];
const REGISTRATION_PHP = ['http://localhost/Projects/MyMessenger_LOCAL/php/registration.php', 'https://mymessengerbackend.000webhostapp.com/php/registration.php'];
...
const GET_ALL_USERS_PHP = ['http://localhost/Projects/MyMessenger_LOCAL/php/getAllUsers.php', 'https://mymessengerbackend.000webhostapp.com/php/getAllUsers.php'];
const GET_ALL_CHATS_PHP = ['http://localhost/Projects/MyMessenger_LOCAL/php/getAllChats.php', 'https://mymessengerbackend.000webhostapp.com/php/getAllChats.php'];
const GET_FULL_NAME_PHP = ['http://localhost/Projects/MyMessenger_LOCAL/php/getFullName.php', 'https://mymessengerbackend.000webhostapp.com/php/getFullName.php'];
const GET_MESSAGES_PHP = ['http://localhost/Projects/MyMessenger_LOCAL/php/getMessages.php', 'https://mymessengerbackend.000webhostapp.com/php/getMessages.php'];